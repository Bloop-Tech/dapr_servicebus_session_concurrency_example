...
public class MessageController : ControllerBase
{
    ...
    public async Task<IActionResult> ProcessMessage([FromBody] Message message)
    {
        ...
        _logger.LogInformation(
            "Message received for session {SessionId} at {CurrentTime}. Waiting 10 seconds before processing..." +
    ...
    public async Task<IActionResult> PublishMessage()
    {
        try
        {
            ...
            {
                Content = $"Message 1 - Should be processed first",
            ...
            {
                Content = $"Message 2 - Should be processed second, after Message 1 completes",
                Timestamp = DateTime.UtcNow
            };
